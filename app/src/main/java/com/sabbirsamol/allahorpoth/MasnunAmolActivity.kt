...
class MasnunAmolActivity : ComponentActivity() {
    ...
    private val folder2 = DoaFolder(
        ...
        doasList = listOf(
            ...
            DoaItem("১৪. সূরা আল-কাফিরুন", "اللهِ الرَّحْمَنِ الرَّحِيمِ\nقُلْ يَأَيُّهَا الْكَفِرُونَ لا أَعْبُدُ مَا تَعْبُدُونَ وَلَا أَنتُونَ عَبدُونَ مَا أَعْبُدُ وَلَا أَنَا عَابِدُ مَا عَبَدُ تُم وَ لا أَنْتُمْ عِبدُونَ مَا أَعْبُدُهُ لَكُمْ دِينَكُمْ وَإِلَى دِينِ"),
    ...
    private val folder3 = DoaFolder(
        ...
        doasList = listOf(
            ...
            DoaItem("২৪। ভালো কিছু দেখে", "مَا شَاءَ اللَّهُ لَا قُوَّةَ إِلَّا بِاللَّهِ", "মা শা আল্লাহ, লা কুওয়াতা ইল্লা বিল্লাহ।", "আল্লাহ যা চেয়েছেন তাই হয়েছে, আল্লাহ ছাড়া কোনো শক্তি নেই।"),
